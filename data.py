...
d_massages = {"weather_intro": "выберите из списка:<сегодня>, <неделя>",
              "back": "чтобы вернуться назад, введите /back",
              "start": "Возможные команды: \n/exchange - конвертировать валюту\
\n/weather - погода в г. Москва",
              "exchange": "для конвертации валюты введите данные в следующем формате\n \
